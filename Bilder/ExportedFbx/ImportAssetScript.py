...
#Use this command : py "C:\Users\heads\OneDrive\Рабочий стол\Git PUSH\Level-arc\Bilder\ExportedFbx\ImportAssetScript.py"
	...
	def CreateTask_SM_Cube038():
		...
		print('================[ New import task : Cube.038 as StaticMesh type ]================')
		FilePath = os.path.join(r'C:\Users\heads\OneDrive\Рабочий стол\Git PUSH\Level-arc\Bilder\ExportedFbx\StaticMesh\SM_Cube038.fbx')
		AdditionalParameterLoc = os.path.join(r'C:\Users\heads\OneDrive\Рабочий стол\Git PUSH\Level-arc\Bilder\ExportedFbx\StaticMesh\SM_Cube.038_AdditionalParameter.ini')
		...
		if asset == None:
			ImportFailList.append('Asset "Cube.038" not found for after inport')
			return
		print('========================= Imports of Cube.038 completed ! Post treatment started...	=========================')
		...
		for x, lod in enumerate(lods_to_add):
			pass
		print('========================= Post treatment of Cube.038 completed !	 =========================')
		ImportedList.append([asset, 'StaticMesh'])
	CreateTask_SM_Cube038()
